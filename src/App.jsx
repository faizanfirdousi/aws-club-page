...
const latestEvent = {
  ...
  description: "Join us as we break down the complexities of cloud technology, highlight the opportunities available through our club, and outline our vision for an exciting journey ahead.",
...
const faqData = [
  ...
  },
  {
    ...
    answer: "Cloud computing is one of the most in-demand skills in the tech industry today. By joining, you'll gain practical experience, prepare for industry-recognized AWS Certifications, build resume-worthy projects, and network with professionals.",
  },
];
          ...
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
              <Card className="text-center group">
                ...
                <p className="text-gray-400">Get practical experience with real AWS services. Build projects that matter and learn by doing.</p>
              </Card>
              ...
              <Card className="text-center group">
                ...
                <p className="text-gray-400">Connect with like-minded students, industry experts, and AWS professionals in our community.</p>
              </Card>
              ...
              <Card className="text-center group">
                ...
                <p className="text-gray-400">Prepare for AWS certifications, get resume reviews, and discover internship opportunities.</p>
              </Card>
            </div>
          </div>
        </section>
          ...
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div className="text-center mb-16">
              ...
              <p className="max-w-2xl mx-auto text-lg text-gray-400">
                A visual timeline of our journey, events, and the amazing people who make up our community.
              </p>
            </div>

            {/* Coming Soon Banner */}
            <div className="relative flex items-center justify-center w-full h-[400px] md:h-[500px] rounded-3xl bg-white/[0.03] border border-fuchsia-500/20 backdrop-blur-xl shadow-2xl overflow-hidden group hover:border-fuchsia-400/40 transition-all duration-500">
              ...
              <div className="relative text-center p-8 z-10">
                ...
                <h3 className="text-4xl md:text-5xl font-extrabold tracking-widest uppercase mb-4 text-transparent bg-clip-text bg-gradient-to-r from-violet-300 via-fuchsia-300 to-rose-300">
                  Coming Soon
                </h3>
          ...
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div className="bg-white/[0.04] backdrop-blur-xl rounded-3xl p-10 md:p-16 text-center border border-white/10 shadow-2xl relative overflow-hidden">
              ...
              <p className="text-xl text-gray-300 mb-10 max-w-2xl mx-auto relative z-10">
                Learn AWS step by step with peers, apply concepts in small projects, and grow into cloud, DevOps, and modern infrastructure.
              </p>
              <div className="relative z-10">
