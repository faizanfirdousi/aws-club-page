        ...
        <nav className={`pointer-events-auto w-full transition-all duration-500 ease-in-out relative ${
          ...
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div className="flex items-center justify-between h-16 lg:h-20">
              ...
              >
                <div className={`flex items-center justify-center w-10 h-10 rounded-xl bg-gradient-to-br from-fuchsia-600 to-indigo-600 shadow-[inset_0_1px_2px_rgba(255,255,255,0.6),0_4px_10px_rgba(139,92,246,0.5)] group-hover:shadow-[inset_0_1px_2px_rgba(255,255,255,0.8),0_8px_20px_rgba(139,92,246,0.8)] transition-all duration-300 ${isScrolled ? 'scale-90 shadow-none' : 'group-hover:-translate-y-0.5'}`}>
                  <svg viewBox="0 0 640 512" fill="currentColor" className="w-5 h-5 text-white drop-shadow-[0_2px_2px_rgba(0,0,0,0.5)]">
              ...
              <div className="flex flex-col">
                <span className="font-bold text-white text-lg lg:text-xl tracking-wide drop-shadow-md hidden sm:flex items-center gap-1.5">
            ...
            <a
              ...
              className="px-5 py-2 z-10 relative bg-gradient-to-b from-white to-gray-200 text-black text-xs sm:text-sm font-bold tracking-wide rounded-full border-b-[3px] border-gray-400 hover:border-b-[2px] hover:translate-y-[1px] active:border-b-[0px] active:translate-y-[3px] transition-all duration-100 flex-shrink-0 shadow-[0_4px_10px_rgba(255,255,255,0.2)] active:shadow-[inset_0_2px_4px_rgba(0,0,0,0.3)] select-none ml-2 lg:ml-0"
            >
              Join Us
            </a>
