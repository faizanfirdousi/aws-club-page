...
function HeroGeometric({
  ...
  return (
    <div className="relative min-h-screen w-full flex items-center justify-center overflow-hidden bg-[#030303]">
      <div className="absolute inset-0 bg-gradient-to-br from-violet-500/[0.08] via-transparent to-rose-500/[0.08] blur-3xl" />
      ...
      <div className="absolute inset-0 overflow-hidden">
        ...
        <ElegantShape
          ...
          height={60}
          rotate={20}
          gradient="from-fuchsia-500/[0.25]"
        ...
        <div className="max-w-3xl mx-auto text-center">
          ...
          >
            <h1 className="text-4xl sm:text-6xl md:text-7xl font-bold mb-6 md:mb-8 tracking-tight">
              ...
              <span
                className={cn(
                  "bg-clip-text text-transparent bg-gradient-to-r from-violet-300 via-fuchsia-200 to-rose-300",
                )}
              >
                {title2}
              </span>
